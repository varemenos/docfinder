...
c<d.results.length;c++){$("#results").append(' 							<div class="result">								<h3><a class="resultLink" href="'+d.results[c].url+'">'+d.results[c].name+"</a> ["+d.results[c].type+']</h3>								<p class="description">'+d.results[c].description+'</p>								<p class="synopsis">'+d.results[c].synopsis+'</p>								<div class="namespace">'+d.results[c].namespace+"</div>							</div>						");
